<template>
  <div class="page">
    <h1>Интернет-магазин слаймов JSHOP</h1>
    <p>
    ...
    <h3>JSHOP - это:</h3>
    <ul>
      <li>Крупнейший интернет-магазин самых популярных слаймов в России</li>
      <li>Гарантии качества слаймов по доступным ценам</li>
